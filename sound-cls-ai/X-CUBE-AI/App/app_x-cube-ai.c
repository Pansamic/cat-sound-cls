...
AI_ALIGNED(32)
static uint8_t pool0[AI_CAT_SOUND_CLS_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_CAT_SOUND_CLS_MODEL_NAME,
        .config = AI_CAT_SOUND_CLS_DATA_CONFIG,
        .ai_get_report = ai_cat_sound_cls_get_report,
        .ai_create = ai_cat_sound_cls_create,
        .ai_destroy = ai_cat_sound_cls_destroy,
        .ai_get_error = ai_cat_sound_cls_get_error,
        .ai_init = ai_cat_sound_cls_init,
        .ai_run = ai_cat_sound_cls_run,
        .ai_forward = ai_cat_sound_cls_forward,
        .ai_data_params_get = ai_cat_sound_cls_data_params_get,
