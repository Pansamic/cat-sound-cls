...
#ifndef AI_CAT_SOUND_CLS_H
#define AI_CAT_SOUND_CLS_H
#pragma once
...
/******************************************************************************/
#define AI_CAT_SOUND_CLS_MODEL_NAME          "cat_sound_cls"
#define AI_CAT_SOUND_CLS_ORIGIN_MODEL_NAME   "cat_sound_classification_model"

/******************************************************************************/
#define AI_CAT_SOUND_CLS_ACTIVATIONS_ALIGNMENT   (4)
#define AI_CAT_SOUND_CLS_INPUTS_IN_ACTIVATIONS   (4)
#define AI_CAT_SOUND_CLS_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_CAT_SOUND_CLS_IN_NUM        (1)

AI_DEPRECATED
#define AI_CAT_SOUND_CLS_IN \
  ai_cat_sound_cls_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_CAT_SOUND_CLS_IN_SIZE { \
  AI_CAT_SOUND_CLS_IN_1_SIZE, \
}
#define AI_CAT_SOUND_CLS_IN_SIZE_BYTES { \
  AI_CAT_SOUND_CLS_IN_1_SIZE_BYTES, \
}
#define AI_CAT_SOUND_CLS_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_CAT_SOUND_CLS_IN_1_CHANNEL     (2600)
#define AI_CAT_SOUND_CLS_IN_1_SIZE        (2600)
#define AI_CAT_SOUND_CLS_IN_1_SIZE_BYTES  (10400)

/******************************************************************************/
#define AI_CAT_SOUND_CLS_OUT_NUM       (1)

AI_DEPRECATED
#define AI_CAT_SOUND_CLS_OUT \
  ai_cat_sound_cls_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_CAT_SOUND_CLS_OUT_SIZE { \
  AI_CAT_SOUND_CLS_OUT_1_SIZE, \
}
#define AI_CAT_SOUND_CLS_OUT_SIZE_BYTES { \
  AI_CAT_SOUND_CLS_OUT_1_SIZE_BYTES, \
}
#define AI_CAT_SOUND_CLS_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_CAT_SOUND_CLS_OUT_1_CHANNEL     (10)
#define AI_CAT_SOUND_CLS_OUT_1_SIZE        (10)
#define AI_CAT_SOUND_CLS_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_CAT_SOUND_CLS_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup cat_sound_cls
 ...
 * @ref ai_cat_sound_cls_create. Both the activations memory buffer 
 ...
 * using @ref ai_cat_sound_cls_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cat_sound_cls_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_cat_sound_cls_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_CAT_SOUND_CLS_*
 * defines into file @ref cat_sound_cls.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cat_sound_cls_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_CAT_SOUND_CLS_H */
