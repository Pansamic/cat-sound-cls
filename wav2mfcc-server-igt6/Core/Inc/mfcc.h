...
#define FRAME_SIZE_IN_BYTES  (FRAME_SIZE*sizeof(float))       // unit:byte
...
#define NUM_FRAME            (200)        // the number of frames
#define NUM_MFCC             (13)         // the number of MFCC coefficients
